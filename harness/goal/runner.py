    ...
    def _prepare_tests(self, state: GoalState) -> None:
        ...
        for task_id in task_ids:
            ...
            prompt = (
                ...
                "differ from HEAD. Do not use git show HEAD/git diff HEAD as a test oracle, and do not assert a whole "
                "configuration file equals HEAD. Test the explicit current-state acceptance cases and preserve behavior "
                "outside this Task only when the contract names that behavior. "
